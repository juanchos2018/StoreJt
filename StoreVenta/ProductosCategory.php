                    ...
                    <div class="row">
                        <div class="col-lg-9 order-1 order-lg-2">
                            ...
                            <div class="single-banner shop-page-banner">
                                <a href="#">
                                    <img src="imags/bg-banner/2.jpg" alt="Li's Static Banner">
                                </a>
                            </div>
                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                                ...
                                                                <img src="http://localhost/Storejt/backend/<?php echo $row[12]; ?>" alt="Li's Product Image">
                                                            </a>
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="single-product.html"> <?php echo $row[6]; ?>  </a></h4>
                                                                <div class="price-box">
                                                                    <input type="hidden" value="'<?php echo $IdCategoria ?>'"> 
                                                                    <span class="new-price">S/. <?php echo $row[9]; ?> </span>
                                                                </div>
                                                            </div>
                                                            <div class="add-actions">
                                                                <ul class="add-actions-link">
                                                                    <li class="add-cart active"><a  onclick="AddCart('<?php echo $row[0] ?>','<?php echo $row[9]; ?>')" >Agregar</a></li>
